...
extern struct complex complex_add(struct complex x, struct complex y);
...
extern struct complex complex_sub(struct complex x, struct complex y);
...
extern struct complex complex_mul(struct complex x, struct complex y);
...
/// </returns>
extern struct complex complex_div(struct complex x, struct complex y);
...
extern struct complex complex_conj(struct complex z);
...
/// <param name="z"></param>
/// <returns></returns>
extern double complex_mag2(struct complex z);
...
extern double complex_mag(struct complex z);
...
extern double complex_arg(struct complex z);
...
extern struct complex complex_from_polar(double arg, double mag);
